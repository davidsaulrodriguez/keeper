...
1. Fork the project (```https://github.com/davidsaulrodriguez/keeper```)
2. Clone it on your machine (```git clone https://github.com/yourUsername/keeper.git```)
3. Add the upstream remote (```git remote add upstream https://github.com/davidsaulrodriguez/keeper.git```)
